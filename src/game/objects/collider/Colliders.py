...
class ActuatorCollider(RectangleCollider, Actuator):
    def __init__(self, x:int|Percent, y:int|Percent, w:int|Percent, h:int|Percent, priority: int, hardColliding: bool, activateds: list[Activated], texture:Color|str|None, surface:Surface) -> None:
